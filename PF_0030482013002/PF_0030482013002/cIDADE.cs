...
namespace PF_0030482013002
{
    class Cidade
    {
        ...
        public DataTable Listar()
        {
            ...
            try
            {
                daCidade = new SqlDataAdapter("SELECT * FROM TBCIDADE", frmCadCidades.conexao);
        ...
        public int Salvar()
        {
            ...
            try
            {
                ...
                mycommand = new SqlCommand("INSERT INTO TBCIDADE VALUES (@nome_cidade, @uf_cidade)", frmCadCidades.conexao);
        ...
        public int Alterar()
        {
            ...
            try
            {
                ...
                mycommand = new SqlCommand("UPDATE TBCIDADE SET nome_cidade = @nome_cidade, @uf_cidade WHERE id_cidade = @id_cidade", frmCadCidades.conexao);
        ...
        public int Excluir()
        {
            ...
            {
                SqlCommand mycommand;
                mycommand = new SqlCommand("DELETE FROM TBCIDADE WHERE id_cidade = @id_cidade", frmCadCidades.conexao);
